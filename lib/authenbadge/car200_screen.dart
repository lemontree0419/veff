...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Car200Screen(),
    );
  }
}

class Car200Screen extends StatefulWidget {
  const Car200Screen({Key? key}) : super(key: key);

  @override
  _Car200ScreenState createState() => _Car200ScreenState();
}

class _Car200ScreenState extends State<Car200Screen> {
  ...
  Future<void> _uploadImages() async {
    ...
    for (var image in _pickedImages) {
      final ref = FirebaseStorage.instance.ref("car_u200/${image.path.split('/').last}");
