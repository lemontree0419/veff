...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Car50Screen(),
    );
  }
}

class Car50Screen extends StatefulWidget {
  const Car50Screen({Key? key}) : super(key: key);

  @override
  _Car50ScreenState createState() => _Car50ScreenState();
}

class _Car50ScreenState extends State<Car50Screen> {
  ...
  Future<void> _uploadImages() async {
    ...
    for (var image in _pickedImages) {
      final ref = FirebaseStorage.instance.ref("car_u50/${image.path.split('/').last}");
