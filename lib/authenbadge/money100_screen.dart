...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Money100Screen(),
    );
  }
}

class Money100Screen extends StatefulWidget {
  const Money100Screen({Key? key}) : super(key: key);

  @override
  _Money100ScreenState createState() => _Money100ScreenState();
}

class _Money100ScreenState extends State<Money100Screen> {
  ...
  Future<void> _uploadImages() async {
    ...
    for (var image in _pickedImages) {
      final ref = FirebaseStorage.instance.ref("money_100/${image.path.split('/').last}");
