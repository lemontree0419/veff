...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Car100Screen(),
    );
  }
}

class Car100Screen extends StatefulWidget {
  const Car100Screen({Key? key}) : super(key: key);

  @override
  _Car100ScreenState createState() => _Car100ScreenState();
}

class _Car100ScreenState extends State<Car100Screen> {
  ...
  Future<void> _uploadImages() async {
    ...
    for (var image in _pickedImages) {
      final ref = FirebaseStorage.instance.ref("car_u100/${image.path.split('/').last}");
