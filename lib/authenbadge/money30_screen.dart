...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Money30Screen(),
    );
  }
}

class Money30Screen extends StatefulWidget {
  const Money30Screen({Key? key}) : super(key: key);

  @override
  _Money30ScreenState createState() => _Money30ScreenState();
}

class _Money30ScreenState extends State<Money30Screen> {
  ...
  Future<void> _uploadImages() async {
    ...
    for (var image in _pickedImages) {
      final ref = FirebaseStorage.instance.ref("money_30/${image.path.split('/').last}");
