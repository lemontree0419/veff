...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Money70Screen(),
    );
  }
}

class Money70Screen extends StatefulWidget {
  const Money70Screen({Key? key}) : super(key: key);

  @override
  _Money70ScreenState createState() => _Money70ScreenState();
}

class _Money70ScreenState extends State<Money70Screen> {
  ...
  Future<void> _uploadImages() async {
    ...
    for (var image in _pickedImages) {
      final ref = FirebaseStorage.instance.ref("money_70/${image.path.split('/').last}");
